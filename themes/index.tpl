			...
			{else}
				<div class="main-content-header">
					<div class="col-md-4 onvan">
						<span>عنوان کالا</span>&nbsp; | <span id="product_name"></span> 
					</div>
					<div class="col-md-4 tedad">
						<span>تعداد کالا</span>&nbsp; | <span id="product_num"></span> 
					</div>
					<div class="col-md-4 pishnahad">
					<span id="product_pishnahad">
						تا کنون این کالا به ۴ نفر پیشنهاد شده
						</span>
