                          ...
                          <div class="row">
                            <div class="form-group">
                              <div class="col-md-6 col-sm-6">
                                <label>عنوان </label>
                                <input type="text" name="title" value="{$page['title']|stripslashes}" class="form-control">
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <label>لینک </label>
                                <div class="row">
                                	
                                		<input type="text" name="slug" value="{$page['slug']|stripslashes}" class="form-control text-right col-md-offset-2 col-md-4">
                         ...
                         <div class="row">
                            <div class="form-group">
                              <div class="col-md-12 col-sm-6">
                                <label>متن</label>
                                <textarea name="content" rows="4" placeholder=" متن را وارد نمایید."  data-height="300" data-lang="fa-IR" class="form-control summernote">{$page['content']|stripslashes}</textarea>
                              </div>
                            </div>
                         </div>
