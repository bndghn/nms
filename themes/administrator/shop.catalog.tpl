    ...
    <div id="content" class="padding-20">
       ...
       <div id="panel-ui-tan-l2" class="panel panel-default">
                      ...
                      <ul class="nav nav-tabs nav-stacked">
                          <li class="active">
                              <a href="#active_pro" data-toggle="tab">
                                  ...
                                  {insert name=get_pro_count value=var stock_status=1 assign=ProConutExcited}
                                  {$ProConutExcited}
                                  </span>
                            فروش عادی
                              </a>
                          ...
                          <li>
                              <a href="#delay_pro" data-toggle="tab">
                                  <span class="badge badge-warning pull-right">
                                  {insert name=get_pro_count value=var  stock_status=2 assign=delayExcited}
                                  {$delayExcited}
                                  </span>
                                  انتظار برای تولید
                              </a>
                          ...
                          <li>
                              <a href="#deactive_pro" data-toggle="tab">
                                  <span class="badge badge-warning pull-right">
                                  {insert name=get_pro_count value=var stock_status=0 assign=notExcited}
                                  {$notExcited}
                                  </span>
                                  عدم سفارش
                              </a>
                        ...
                        <div id="active_pro" class="tab-pane active">
                                <div class="table-responsive">
                                      <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                                          ...
                                          <tbody>
                                              {insert name=get_product_list value=gvar stock_status=1 assign=pro_List}
                                              
                                              {if $pro_List ne null}
                                              
                                              {insert name=get_product_cat value=var stock_status=1  assign=pro_cat}
                         ...
                         <div id="delay_pro" class="tab-pane">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                                    ...
                                    <tbody>
                                        {insert name=get_product_list value=gvar stock_status=2 assign=pro_Lisst}
                                        {if $pro_Lisst ne null}
                                        {insert name=get_product_cat value=var stock_status=2 assign=pro_cat}
                                        {foreach from=$pro_cat item=de_pro}
                                        ...
                                        <td class="text-center  align-middle">
                                            ...
                                            <a href="{$adminurl}/shop.catalog.edit.php?proid={$de_pro['proid']}" class="btn btn-default btn-xs" ><i class="fa fa-edit white"></i> {$lang35} </a>

                                            <a href="{$adminurl}/shop.catalog.delete.php?proid={$de_pro['proid']}" onclick="{literal} return confirm('آیا از حذف این محصول مطمئن هستید؟!');{/literal}" class="btn btn-danger btn-xs"><i class="fa fa-times white"></i> {$lang34} </a>
                          ...
                          <div id="deactive_pro" class="tab-pane">
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                                  ...
                                  <tbody>
                                      {insert name=get_product_list value=gvar stock_status=0  assign=pro_Listt}
                                      {if $pro_List ne null}
                                      {insert name=get_product_cat value=var stock_status=0 assign=pro_cat}
          ...
          <div class="panel-footer clearfix">
            ...
            <a href="{$adminurl}/shop.catalog.add.php" class="btn btn-success pull-right btn-sm nomargin-top nomargin-bottom"><i class="fa fa-edit white"></i>ثبت محصول جدید</a>
